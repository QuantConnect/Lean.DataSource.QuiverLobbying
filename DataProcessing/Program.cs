...
namespace QuantConnect.DataProcessing
{
    ...
    public class Program
    {
        ...
        public static void Main()
        {
            ...
            {
                Log.Error(err, $"QuantConnect.DataProcessing.Program.Main(): The downloader/converter for {QuiverLobbyingDataDownloader.VendorDataName} {QuiverLobbyingDataDownloader.VendorDataName} data failed to be constructed");
                Environment.Exit(1);
            }
            ...
            {
                Log.Error(err, $"QuantConnect.DataProcessing.Program.Main(): The downloader/converter for {QuiverLobbyingDataDownloader.VendorDataName} {QuiverLobbyingDataDownloader.VendorDataName} data exited unexpectedly");
                Environment.Exit(1);
            }
            finally
            {
